...
namespace CompanyService
{
    ...
    public class CompanyService : ICompanyPublicService, ICompanyConfidentialService
    {
        ...
        {
            return "This is a confidential service and can be accessed only over the tcp protocol ";
        }

        public string GetPublicInformation()
        {
            return "This is a public infomration and can be accessed publically over Http protocol";
